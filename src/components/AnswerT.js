    ...
    return(
        <div>
             <textarea placeholder="Answer" type="answer"  onChange={(event) => {
                ...
                setId((loc.state.my_uid).toString()) ;
            } 
                


              } />
             <button onClick={()=>myAnswer({ doc_id, u_u, u_username, u_email, u_caption, u_question, u_answer, u_correct: "Not Yet Marked"})}>Submit</button>
...
//     const ref = firebase.firestore().collection('AllAnswers').doc(doc_id) ;
